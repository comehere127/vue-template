...
const deviceDetection = {
  isMobile: function(ua = navigator.userAgent) {
    return isMobile(ua)
  },
  isMobileOrTablet: function(ua = navigator.userAgent) {
    return isMobileOrTablet(ua)
  },
  isTablet: function(ua = navigator.userAgent) {
    return !isMobile(ua) && isMobileOrTablet(ua)
  },
  isDesktop: function(ua = navigator.userAgent) {
    return !isMobileOrTablet(ua)
  }
}
